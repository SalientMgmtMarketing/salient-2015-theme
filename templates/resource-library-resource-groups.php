      ...
      if ( have_rows('list_items') ) :
        ...
        while ( have_rows('list_items') ) : the_row();
          ...
          echo '<div class="media">';
            echo '<a class="media-left" href="' . $file . '" title=' . json_encode($title) . '>';
              if ( $thumbnail ) {
            ...
            echo '<div class="media-body">';
              ...
              echo '<p style="margin-bottom: 0;"><a class="btn btn-primary btn-xs" href="' . $file . '" title=' . json_encode($title) . '>View the file <i class="fa fa-chevron-right"></i></a></p>';
            echo '</div>';
          echo '</div>';
        endwhile;
