    ...
    <div class="wrap">
      <div class="entry-content">
        ...
        <div id="password-gate">
          <p>To access this page, please enter the password provided by your account representative.</p>

          <form id="protected-form" class="protected-form" name="protectedformCoke" action="#" method="POST">
